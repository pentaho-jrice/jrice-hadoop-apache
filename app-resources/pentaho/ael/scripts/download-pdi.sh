...
echo "*********************************************************************************"
echo "   Unzipping PDI..."
echo "    - from this file:  pdi-ee-client-$PDI_FILE_VERSION_NUMBER.zip "
echo "    - To this dir:     $PDI_DIST_DIR/$PDI_FILE_VERSION_NUMBER/ee "
echo "*********************************************************************************"

time unzip pdi-ee-client-$PDI_FILE_VERSION_NUMBER.zip -d $PDI_DIST_DIR/$PDI_FILE_VERSION_NUMBER/ee
...
cp $PENTAHO_PDI_APP_CONFIG_FILES_DIR/spoon.sh $PDI_DIST_DIR/$PDI_FILE_VERSION_NUMBER/ee/data-integration
cp $PENTAHO_PDI_APP_CONFIG_FILES_DIR/Spoon.bat $PDI_DIST_DIR/$PDI_FILE_VERSION_NUMBER/ee/data-integration
...
#
cp $PENTAHO_AEL_APP_CONFIG_FILES_DIR/application.properties $AEL_DIST_DIR/latest/data-integration/adaptive-execution/config/application.properties
